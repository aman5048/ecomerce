        ...
        <Link to={`/product-detail/${product.id}`} key={product.id}>
          ...
          <div className="mt-4 flex justify-between">
            <div>
              ...
              <p className="mt-1 text-sm  text-yellow-500"><StarIcon className='h-5 w-5 inline'></StarIcon>
              <span className='align-bottom'>{product.rating}
              </span></p>
            </div>
            <div>
            <p className="text-sm font-medium text-green-900">Rs.{discountedPrice(product)}</p>
